...
class Property {
    ...
    public function getAll($filters = []) {
        ...
        if (!empty($filters['keyword'])) {
            $query .= " AND (p.title LIKE :keyword OR p.description LIKE :keyword OR p.district LIKE :keyword OR p.address LIKE :keyword OR p.property_type LIKE :keyword)";
        ...
        foreach ($properties as &$property) {
            ...
            error_log("Property " . $property['id'] . " has " . count($property['images']) . " images");
        }
    ...
    public function getById($id) {
        ...
        if ($property) {
            ...
            error_log("Property images count: " . count($property['images']));
        }
    ...
    public function getAllPaginated(array $filters, int $page, int $limit): array {
        ...
        if (!empty($filters['keyword'])) {
            $where[] = '(p.title LIKE :keyword OR p.description LIKE :keyword OR p.district LIKE :keyword OR p.address LIKE :keyword OR p.property_type LIKE :keyword)';
            $params[':keyword'] = '%' . $filters['keyword'] . '%';
        }
